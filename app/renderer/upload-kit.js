...
[right][size=8]${opts.edited ? 'Edited' : 'Generated'} by SHRI-Tools${appVersion ? ` v${appVersion}` : ''}[/size][/right]
[/code]`;
  }
  ...
  return {
    ...
    showBbcodePreview(content) {
      if (!ui.bbcodePreviewModal || !ui.bbcodePreviewContent) return;
