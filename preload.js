...
contextBridge.exposeInMainWorld('api', {
  ...
  probeVideo: (payload) => ipcRenderer.invoke('probe-video', payload),
  previewFrame: (payload) => ipcRenderer.invoke('preview-frame', payload),
  captureFrame: (payload) => ipcRenderer.invoke('capture-frame', payload),
  deleteFile: (filePath) => ipcRenderer.invoke('delete-file', filePath),
  getUploadHistory: () => ipcRenderer.invoke('upload-history:get'),
  addUploadHistory: (entry) => ipcRenderer.invoke('upload-history:add', entry),
  deleteUploadHistory: (id) => ipcRenderer.invoke('upload-history:delete', id),
  clearUploadHistory: () => ipcRenderer.invoke('upload-history:clear'),
